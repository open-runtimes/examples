...
A Node Generate Map Function for generate a screenshot of map location using [OpenStreetMap](https://www.openstreetmap.org/).

_Example input:_

```json
{
    "provider": "openstreets",
    "lat": 41.909986,
    "lng": 12.3959136
}
```
