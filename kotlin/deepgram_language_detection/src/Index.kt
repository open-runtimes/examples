...
val DEEPGRAM_LANGUAGE_DETECTION_API_END_POINT = "https://api.deepgram.com/v1/listen?model=general&detect_language=true&punctuate=true"
val gson = Gson()
...
suspend fun main(req: RuntimeRequest, res: RuntimeResponse): RuntimeResponse {
    ...
    val url = URL(DEEPGRAM_LANGUAGE_DETECTION_API_END_POINT)
