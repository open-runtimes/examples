...
val DEEPGRAM_AUDIO_SUMMARY_API_END_POINT = "https://api.deepgram.com/v1/listen?summarize=true&punctuate=true"
val gson = Gson()
...
suspend fun main(req: RuntimeRequest, res: RuntimeResponse): RuntimeResponse {
    ...
    val url = URL(DEEPGRAM_AUDIO_SUMMARY_API_END_POINT)
