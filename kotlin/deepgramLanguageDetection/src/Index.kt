...
val DEEPGRAM_LANGUAGE_DETECT_API_END_POINT = "https://api.deepgram.com/v1/listen?detect_language=true&punctuate=true"
val gson = Gson()
...
suspend fun main(req: RuntimeRequest, res: RuntimeResponse): RuntimeResponse {
    ...
    if (deepgramApiKey.trim().isEmpty()) {
    ...
    val url = URL(DEEPGRAM_LANGUAGE_DETECT_API_END_POINT)
