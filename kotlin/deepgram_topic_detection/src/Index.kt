...
val DEEPGRAM_TOPIC_DETECTION_API_END_POINT = "https://api.deepgram.com/v1/listen?detect_topics=true&punctuate=true"
val gson = Gson()
...
suspend fun main(req: RuntimeRequest, res: RuntimeResponse): RuntimeResponse {
    ...
    if (fileUrl.isEmpty() || fileUrl.trim().isEmpty()) {
        return getErrorResponseWithMessage(res, "Please provide a valid file URL.")
    }

    val url = URL(DEEPGRAM_TOPIC_DETECTION_API_END_POINT)
