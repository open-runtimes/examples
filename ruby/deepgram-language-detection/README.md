# 🗣️ Detect Language with Deepgram

A Ruby Cloud Function for detecting language number using [Deepgram API](https://deepgram.com/).
...
$ cd ruby/deepgram-language-detection
```
